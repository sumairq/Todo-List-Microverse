...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_todoCollection_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/todoCollection.js */ \"./src/modules/todoCollection.js\");\n/* harmony import */ var _modules_item_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/item.js */ \"./src/modules/item.js\");\n/* harmony import */ var _modules_clearCompleted_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/clearCompleted.js */ \"./src/modules/clearCompleted.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\n\nconst tasksCol = new _modules_todoCollection_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\nconst input = document.querySelector('.task-input');\n\nif (localStorage.getItem('tasksList')) {\n  const storageItems = JSON.parse(localStorage.getItem('tasksList')).tasksList;\n  storageItems.forEach((task) => {\n    tasksCol.display(new _modules_item_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](task.index, task.description, task.completed));\n  });\n}\n\nwindow.addEventListener('keydown', (e) => {\n  if (e.keyCode === 13 && input.value !== '') {\n    tasksCol.display(new _modules_item_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](tasksCol.list.length, input.value, false));\n    input.value = '';\n  }\n});\n\nconst clearButton = document.querySelector('.clear-completed');\n\nclearButton.addEventListener('click', () => {\n  const originalArray = tasksCol.list;\n  tasksCol.list = (0,_modules_clearCompleted_js__WEBPACK_IMPORTED_MODULE_2__.clear)(tasksCol);\n  tasksCol.setStorage();\n  (0,_modules_clearCompleted_js__WEBPACK_IMPORTED_MODULE_2__.removeElements)(originalArray);\n});\n\n\n//# sourceURL=webpack://Todo-List-Microverse/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Item)\n/* harmony export */ });\nclass Item {\n  constructor(index, description, completed) {\n    this.description = description;\n    this.completed = completed;\n    this.index = index;\n  }\n}\n\n\n//# sourceURL=webpack://Todo-List-Microverse/./src/modules/item.js?");
